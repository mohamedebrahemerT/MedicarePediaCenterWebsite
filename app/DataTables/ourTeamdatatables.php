...
class ourTeamdatatables extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('edit', 'Admin.ourTeam.btn.edit')
         ->addColumn('delete', 'Admin.ourTeam.btn.delete')
         ->addColumn('checkbox', 'Admin.ourTeam.btn.checkbox')
         ->addColumn('photo', 'Admin.ourTeam.btn.photo')
     ->addColumn('jobTitle_name_'.session('lang'), 'Admin.ourTeam.btn.jobTitle')
        ->addColumn('name_name_'.session('lang'), 'Admin.ourTeam.btn.name')
        ->addColumn('desc_name_'.session('lang'), 'Admin.ourTeam.btn.desc')

        

        ->rawColumns([
            'edit','delete','checkbox','photo','jobTitle_name_'.session('lang'),
            'name_name_'.session('lang'),
            'desc_name_'.session('lang'),
        ]);
