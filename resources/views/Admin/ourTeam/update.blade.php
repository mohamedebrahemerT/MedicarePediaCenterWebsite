...
@section('content')
 ...
 @push('js')
               ...
               <script>
                ...
                CKEDITOR.replace( 'ourTeam_name_en' , {
        language: '{{session('lang')}}',
});
                CKEDITOR.replace( 'ourTeam_name_ar' , {
        language: '{{session('lang')}}',
});
           ...
           var jobTitle_name_en = $('.jobTitle_name_en').val();
          var jobTitle_name_ar = $('.jobTitle_name_ar').val();  


              
           var name_name_en = $('.name_name_en').val();
          var name_name_ar = $('.name_name_ar').val(); 

           var desc_name_en = $('.desc_name_en').val();
          var desc_name_ar = $('.desc_name_ar').val();   
              ...
              url:'{{ url('admin/ourTeam')}}/{{$ourTeam->id}}',
              ...
              data:{
        "_token": "{{ csrf_token() }}",
        "jobTitle_name_en": jobTitle_name_en,
        "jobTitle_name_ar": jobTitle_name_ar,
      

         "name_name_en": name_name_en,
        "name_name_ar": name_name_ar,

        "desc_name_en": desc_name_en,
        "desc_name_ar": desc_name_ar,
              ...
              success:function(data){
               ...
               $('.AddNew').removeClass('hidden');
                ...
                $('.jobTitle_name_en').addClass('hidden');
                $('.jobTitle_name_ar').addClass('hidden');
                $('.name_name_en').addClass('hidden');
                $('.name_name_ar').addClass('hidden');
                $('.desc_name_en').addClass('hidden');
                $('.desc_name_ar').addClass('hidden');
  ...
  <div class="content-wrapper">
    ...
    <!-- /.content -->
     ...
     <div class="box">
      <div class="box-header">
       <h3 class="box-title">{{ trans('admin.ourTeam') }}</h3>
       </div>
            <!-- /.box-header -->
       <div class="box-body">
       ...
       {{  Form::open(['url'=>'admin/ourTeam','files'=>true,'id'=>'save_from_data'] ) }}
                <div class="tab-content">

    
        
          @include('Admin.ourTeam.updattabs.photo')
               <div class="form-group"> 
        ...
        <div class="form-group"> 
                    ...
                    <a  class="btn btn-danger form-control AddNew hidden" href="{{ url('admin/ourTeam/create') }}"><i class="fa fa-plus"> </i> {{trans('admin.add')}}</a>
